...
export const services = [
    {
        icon: Shield,
        name: "Compliance",
        description: "Comprehensive compliance solutions for your business needs."
    },
    {
        icon: Lock,
        name: "Data Protection and Security",
        description: "Secure your data with industry-standard protection measures."
    },
    {
        icon: FileCheck,
    ...
    },
    {
        ...
        description: "Corporate governance and intellectual property management."
    },
    {
        icon: Handshake,
        name: "Transaction Advisory",
        description: "Expert advisory services for business transactions."
    }
];
...
export const servicesHighlight = [
    ...
    },
    {
        ...
        description: "Achieve regulatory compliance with our proven strategies."
    },
    {
