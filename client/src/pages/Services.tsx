    ...
    const services = [
        {
            ...
            description:
                "Comprehensive NDPR compliance and data security frameworks",
        ...
        },
        {
            ...
            description:
                "Board structures, compliance frameworks, and intellectual property protection",
            image: "/security.jpg",
            features: [
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-8 text-center">
                    <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold text-white mb-6">
                        Our Services
                    </h1>
                    <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
                        Comprehensive compliance solutions designed to help
                        African startups scale with confidence and regulatory
                        certainty.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                            End-to-end compliance solutions tailored for the
                            unique challenges facing African startups
                        </p>
                    </div>
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    ...
                                    <Button
                                        ...
                                        onClick={() =>
                                            window.open(
                                                "https://mail.google.com/mail/?view=cm&to=info@mustarred.com&su=" +
                                                    encodeURIComponent(
                                                        service.name +
                                                            " Inquiry"
                                                    ),
            ...
            <section className="py-20 bg-white">
                <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-8">
                        Let's discuss your compliance needs and create a
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button
                            ...
                            onClick={() =>
                                window.open(
                                    "https://mail.google.com/mail/?view=cm&to=info@mustarred.com&su=Service Inquiry",
                                    "_blank"
                                )
                            }
                        >
